...
import com.aryansa.rizqi.footballapps.presenter.DetailTeamsPresenter
...
import com.aryansa.rizqi.footballapps.view.ui.DetailTeamsUI
...
class DetailTeamsActivity : AppCompatActivity(), DetailTeamsView {
    ...
    private fun addToFavorite() {
        try {
            db.use {
                insert(TeamsDB.TABLE_TEAMS,
                        TeamsDB.TEAMS_ID to mTeams.teamId,
                        TeamsDB.TEAMS_NAME to mTeams.teamName,
                        TeamsDB.BADGE_TEAM to mTeams.teamBadge)
            }
    ...
    private fun removeFromFavorite() {
        try {
            db.use {
                delete(TeamsDB.TABLE_TEAMS, "(TEAMS_ID = {id})",
                        "id" to idTeamDetail)
            }
