...
import com.aryansa.rizqi.footballapps.presenter.DetailMatchesPresenter
...
import com.aryansa.rizqi.footballapps.view.ui.DetailMatchesUI
...
class DetailMatchesActivity : AppCompatActivity(), DetailMatchesView {
    ...
    private fun addToFavorite() {
        try {
            db.use {
                insert(MatchesDB.TABLE_MATCHES,
                        MatchesDB.MATCHES_ID to eventDetail.idEvent,
                        MatchesDB.MATCHES_TIME to eventDetail.dateEvent,
                        MatchesDB.HOME_TEAM to eventDetail.strHomeTeam,
                        MatchesDB.HOME_SCORE to eventDetail.intHomeScore,
                        MatchesDB.AWAY_TEAM to eventDetail.strAwayTeam,
                        MatchesDB.AWAY_SCORE to eventDetail.intAwayScore,
                        MatchesDB.HOME_TEAM_ID to itemHomeId,
                        MatchesDB.AWAY_TEAM_ID to itemAwayId)
            }
    ...
    private fun removeFromFavorite() {
        try {
            db.use {
                delete(MatchesDB.TABLE_MATCHES, "(MATCHES_ID = {id})",
                        "id" to idEventDetail)
            }
